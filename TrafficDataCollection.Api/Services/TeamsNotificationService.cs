...
namespace TrafficDataCollection.Api.Services
{
    ...
    public class NotificationService : INotificationService
    {
        ...
        private readonly String[] _manualErrorCodesForAdmin; 
            ...
            IConfiguration configuration)
        {
            ...
            _manualErrorCodesForAdmin = _configuration.GetSection("NotificationSettings:ManualErrorCodesForAdmin")
            .Get<string[]>() ?? new string[] { "ERR_NO_TL", "ERR_TL_NOT_ACTIVE", "ERR_SEQUENCE" };
        }
